...
/*TCS34725_write8(0x80,0x03);
delay_ms(50);
TCS34725_write8(0x81,0x00);
TCS34725_write8(0x83,0xff);
TCS34725_write8(0x8f,0x00);
delay_ms(50);       */
...
while (1)
      ...
      // Place your code here
        ...
        /*    TCS34725_read8(TCS34725_RDATAL,&L);    
           TCS34725_read8(TCS34725_RDATAH,&H); 
           r=H*256+L;  
                          */  
           lcd_clear();
           lcd_putsf("R=");
